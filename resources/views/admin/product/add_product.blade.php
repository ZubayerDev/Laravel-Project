                    ...
                    <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="barcode" class="form-control" placeholder="Barcode/QR-code">
                                    @error('category_name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="sku" class="form-control" placeholder="0.00">
                            </div>
                        </div>
                        <!-- Col -->
                        <!-- Col -->
                        ...
                        <div class="col-lg-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="short_desp" class="form-control" placeholder="Short Details">
                            </div>
                        </div>
                        <!-- Col -->
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="long_desp" id="summernote" cols="30" rows="5"></textarea>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="add_info" id="summernote2" cols="30" rows="5"></textarea>
                                    @error('category_photo')
                                            <div class="text text-danger">{{ $message }}</div>
                                        @enderror
                                </div>

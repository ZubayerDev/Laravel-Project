            ...
            <div class="container">
                ...
                <div class="featured-categorie-slider owl-carousel">
                    ...
                    <div class="featured-item">
                        <div class="images">
                            <img style="width: 60%; display:unset" src="{{ asset('uploads/category/')}}/{{ $category->category_photo }}" alt="">
                        </div>
                        <div class="text">
                            <h2><a href="{{ route('category.all', $category->category_slug) }}">{{ $category->category_name }}</a></h2>
                        </div>
                    </div>
                    @endforeach
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="product-item">
                                ...
                                <div class="text">
                                    @php
                                        $substr = Str::length($product->product_name)
                                    @endphp
                                    <h2><a href="{{ route('product.details', $product->pruduct_slug) }}">{{ $substr>=10?Str::substr($product->product_name, 0, 10).'...':$product->product_name }}</a></h2>
                                    ...
                                    <div class="shop-btn">
                                        <a class="theme-btn-s2" href="{{ route('product.details', $product->pruduct_slug) }}">Shop Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="text">
                                ...
                                <a class="upcoming-btn" href="{{ route('half.offer.product') }}">Shop Now</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="highlight-wrap">
                            ...
                            @foreach ($letest_product as $l_product)
                            <div class="product-card">
                                <div class="card-image">
                                    <div class="image">
                                        <img src="{{ asset('uploads/product/preview/'.$l_product->product_photo) }}" alt="">
                                    </div>
                                </div>
                                <div class="content">
                                    <h3><a href="product.html">{{$l_product->product_name}}</a></h3>
                                    <div class="rating-product">
                                        <i class="fi flaticon-star"></i>
                                        <i class="fi flaticon-star"></i>
                                        <i class="fi flaticon-star"></i>

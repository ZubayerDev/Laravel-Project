...
<head>
	...
	<link rel="stylesheet" href="{{asset('backend')}}/css/demo_1/magnific-popup.css">
	...
	<div class="main-wrapper">
      ...
      <div class="sidebar-body">
        <ul class="nav">
          ...
          <li class="nav-item nav-category">Product Details</li>
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#uiComponents" role="button" aria-expanded="false" aria-controls="uiComponents">
              <i class="link-icon" data-feather="feather"></i>
              <span class="link-title">Main Category</span>
            ...
            <div class="collapse" id="uiComponents">
              <ul class="nav sub-menu">
                ...
                <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a href="{{ route('allsubcategory.store') }}" class="nav-link">All SubCategory</a>
                  </li>
                  <li class="nav-item">
                      <a href="{{ route('trash.category') }}" class="nav-link">Trash SubCategory</a>
                    </li>
                     {{-------------- Sub Category ----------}}
              </ul>
            </div>
        ...
        <li class="nav-item">
            <a href="../../pages/advanced-ui/sweet-alert.html" class="nav-link">Brading</a>
        </li>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#product" role="button" aria-expanded="false" aria-controls="tables">
